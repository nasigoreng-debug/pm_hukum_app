                    ...
                    <table class="min-w-full bg-white">
                        <thead class="bg-gray-800 text-white">
                            <tr>
                                ...
                                <th class="py-3 px-4 text-left font-semibold">Register</th>
                                <th class="py-3 px-4 text-left font-semibold">Putus</th>
                                ...
                                <tr class="hover:bg-blue-50 transition-colors duration-150 animate-fade-in clickable-row" data-href="{{ route('perkaras.show', $perkara->id) }}">
                                    ...
                                    <td class="py-3 px-4">
                                        <div class="flex justify-center space-x-1">
                                            <a href="{{ route('perkaras.penetapan-hari-sidang', $perkara->id) }}" 
                                               class="bg-blue-500 hover:bg-blue-600 text-white w-8 h-8 rounded flex items-center justify-center transition-transform duration-200 hover:scale-105" title="Cetak">
                                                cetak
                                            </a>
