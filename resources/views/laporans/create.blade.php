                        ...
                        <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <select name="jenis_laporan" id="jenis_laporan"
                                    class="form-control @error('jenis_laporan') is-invalid @enderror">
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="date" id="tgl_laporan"
                                    ...
                                    value="{{ old('tgl_laporan') }}" name="tgl_laporan">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_laporan')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="file" id="dokumen"
                                    class="form-control @error('dokumen') is-invalid @enderror" value="{{ old('dokumen') }}"
                                    name="dokumen">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('dokumen')
                                        {{ $message }}
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="file" id="konsep"
                                    class="form-control @error('konsep') is-invalid @enderror" value="{{ old('konsep') }}"
                                    name="konsep">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('konsep')
                                        {{ $message }}
