        ...
        <section class="sidebar-user-info">
            <div class="sidebar-user-info-inner">
                <a href="extra-profile.html" class="user-profile">
                    <img src="{{ asset('public/img/'.Auth::user()->foto_user) }}" width="50" height="60" class="img-circle img-corona" alt="Foto Profil" />
                    <span class="user-status is-online" style="font-size: 12px;">
                        ...
                        <p class="text-success"><i class="fa fa-circle"></i> <span>online</span></p>
                    </span>
                </a>
            </div>
        </section>
        ...
        <ul id="main-menu" class="main-menu">
            ...
            @if(Auth::user()->level===1)
                ...
                <li class="opened {{ ( $title === 'Arsip Perkara') ? 'active' : ''}}">
                    <a href="/arsip">
                        <i class="fa fa-file-text-o"></i>
                        <span class="title">Arsip Perkara 2019 s.d {{ date("Y") }}</span>
                    </a>
                </li>
