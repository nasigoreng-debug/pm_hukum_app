                        ...
                        <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="text" class="form-control @error('nama_peminjam') is-invalid @enderror"
                                    value="{{ $pinjam->nama_peminjam }}" name="nama_peminjam" autofocus readonly>
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="text" class="form-control @error('no_banding') is-invalid @enderror"
                                    value="{{ $pinjam->no_banding }}" name="no_banding" readonly>
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_banding')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="date" class="form-control @error('tgl_pinjam') is-invalid @enderror"
                                    value="{{ $pinjam->tgl_pinjam }}" name="tgl_pinjam" readonly>
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_pinjam')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="date" class="form-control @error('tgl_kembali') is-invalid @enderror"
                                    value="{{ $pinjam->tgl_kembali }}" name="tgl_kembali">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_kembali')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="text" class="form-control @error('keterangan') is-invalid @enderror"
                                    value="{{ $pinjam->keterangan }}" name="keterangan">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('keterangan')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="file"
                                    class="form-control form-control-sm @error('bkt_pinjam') is-invalid @enderror"
                                    value="{{ $pinjam->bkt_pinjam }}" name="bkt_pinjam">
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="file"
                                    class="form-control form-control-sm @error('bkt_kembali') is-invalid @enderror"
                                    value="{{ $pinjam->bkt_kembali }}" name="bkt_kembali">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                    @error('bkt_kembali')
                                        {{ $message }}
                                    @enderror
