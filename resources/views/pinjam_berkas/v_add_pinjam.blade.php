                        ...
                        <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="text" class="form-control @error('nama_peminjam') is-invalid @enderror"
                                    value="{{ old('nama_peminjam') }}" name="nama_peminjam" autofocus>
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="date" class="form-control @error('tgl_pinjam') is-invalid @enderror"
                                    value="{{ old('tgl_pinjam') }}" name="tgl_pinjam">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_pinjam')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="date" class="form-control @error('tgl_kembali') is-invalid @enderror"
                                    value="{{ old('tgl_kembali') }}" name="tgl_kembali">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_kembali')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="file"
                                    ...
                                    value="{{ old('bkt_pinjam') }}" name="bkt_pinjam">
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="file"
                                    ...
                                    value="{{ old('bkt_kembali') }}" name="bkt_kembali">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                    @error('bkt_kembali')
                                        {{ $message }}
                                    @enderror
