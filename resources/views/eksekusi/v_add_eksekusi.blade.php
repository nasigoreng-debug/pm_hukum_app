...
<div class="panel panel-default container">
    ...
    <div class="panel-heading">
        <div class="panel-title">
            Tambah Data Perkara Eksekusi
        </div>
    </div>

    <div class="panel-body">

        <form action="/eks/insert" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <!-- left column -->
                <div class="col">
                    ...
                    <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <select name="satker" class="form-control @error('satker') is-invalid @enderror">
                                <option>{{old('satker')}}</option>
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="text" class="form-control @error('no_eksekusi') is-invalid @enderror" value="{{old('no_eksekusi')}}" name="no_eksekusi">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('no_eksekusi')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="text" class="form-control @error('no_put') is-invalid @enderror" value="{{old('no_put')}}" name="no_put">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('no_put')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="date" class="form-control @error('tgl_permohonan') is-invalid @enderror" value="{{old('tgl_permohonan')}}" name="tgl_permohonan">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="date" class="form-control @error('tgl_eks') is-invalid @enderror" value="{{old('tgl_eks')}}" name="tgl_eks">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('tgl_eks')
                                {{ $message }}
                                @enderror
