                        ...
                        <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="text" class="form-control @error('no_eksekusi') is-invalid @enderror"
                                    value="{{ $eksekusi->no_eksekusi }}" name="no_eksekusi" readonly>
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_eksekusi')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="text" class="form-control @error('no_put') is-invalid @enderror"
                                    value="{{ $eksekusi->no_put }}" name="no_put" readonly>
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_put')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="date" class="form-control @error('tgl_permohonan') is-invalid @enderror"
                                    value="{{ $eksekusi->tgl_permohonan }}" name="tgl_permohonan" readonly>
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="date" class="form-control @error('tgl_eks') is-invalid @enderror"
                                    value="{{ $eksekusi->tgl_eks }}" name="tgl_eks">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_eks')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="date" class="form-control @error('tgl_selesai') is-invalid @enderror"
                                    value="{{ $eksekusi->tgl_selesai }}" name="tgl_selesai">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_selesai')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="text" class="form-control @error('keterangan') is-invalid @enderror"
                                    value="{{ $eksekusi->keterangan }}" name="keterangan">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('keterangan')
                                        {{ $message }}
                                    @enderror
