                                ...
                                <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                    ...
                                    <div>
                                        @if ($user->foto_user && file_exists(public_path('storage/users/' . $user->foto_user)))
                                            <img src="{{ asset('public/storage/users/' . $user->foto_user) }}"
                                                alt="" title="" width="40" height="40">
                                        @else
                                            <div class="avatar-placeholder"
                                                style="width:40px; height:40px; background:#ccc; border-radius:50%; display:flex; align-items:center; justify-content:center;">
                                    ...
                                    <div class="">
                                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                            ...
                                            <input type="file"
                                                ...
                                                value="{{ $user->foto_user }}" name="foto_user">
