                    ...
                    @foreach ($jdih as $data)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                @if ($data->dokumen == '')
                                @else
                                    <a href="public/jdih/{{ $data->dokumen }}" class="text-blue"><i
                            ...
                            <td class="text-center" style="font-size: 5px;">
                                @if (Auth::user()->level === 1)
                                    ...
                                    <a href="/himper/edit/{{ $data->id }}" class="btn btn-warning btn-xs">
                        ...
                        <table class="table table-small-font table-bordered table-hover">
                            ...
                            <tr class="text-start border">
                                ...
                                <td>
                                    ...
                                    @if ($data->dokumen == '')
                                    @else
                                        <a href="public/jdih/{{ $data->dokumen }}" class="text-blue" target="_blank"><i
                                                class="fa fa-file-pdf-o"></i></i></a>
                                    @endif
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        <a href="/himper/delete/{{ $data->id }}" type="button" class="btn btn-xs btn-danger">Ya</a>
