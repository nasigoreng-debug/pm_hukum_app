    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $jdih_uu }}" 
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $jdih_perpu }}" 
                 data-decimal="," data-suffix="" data-duration="2.5">
                <div class="xe-icon">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $jdih_pp }}" 
                 data-decimal="," data-suffix="" data-duration="2.5">
                <div class="xe-icon">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $jdih_inpres }}" 
                 data-decimal="," data-suffix="" data-duration="2.5">
                <div class="xe-icon">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $jdih_perma }}" 
                 data-decimal="," data-suffix="" data-duration="2.5">
                <div class="xe-icon">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $jdih_sema }}" 
                 data-decimal="," data-suffix="" data-duration="2.5">
                <div class="xe-icon">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $jdih_sk_kma }}" 
                 data-decimal="," data-suffix="" data-duration="2.5">
                <div class="xe-icon">
                    <i class="fa fa-file-text-o bounce"></i>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $jdih_sk_sekma }}" 
                 data-decimal="," data-suffix="" data-duration="2.5">
                <div class="xe-icon">
                    <i class="fa fa-file-text-o pulse"></i>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $jdih_se_dirjen }}" 
                 data-decimal="," data-suffix="" data-duration="2.5">
                <div class="xe-icon">
                    <i class="fa fa-file-text-o float"></i>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $jdih_sk_dirjen }}" 
                 data-decimal="," data-suffix="" data-duration="2.5">
                <div class="xe-icon">
                    <i class="fa fa-file-text-o spin"></i>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $jdih_se_kpta }}" 
                 data-decimal="," data-suffix="" data-duration="2.5">
                <div class="xe-icon">
                    <i class="fa fa-file-text-o shake"></i>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $jdih_sk_kpta }}" 
                 data-decimal="," data-suffix="" data-duration="2.5">
                <div class="xe-icon">
                    <i class="fa fa-file-text-o grow"></i>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $jdih_peraturan_lainnya }}" 
                 data-decimal="," data-suffix="" data-duration="2.5">
                <div class="xe-icon">
