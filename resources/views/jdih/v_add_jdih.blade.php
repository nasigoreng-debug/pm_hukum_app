                ...
                <div class="col">
                    ...
                    <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="text" class="form-control @error('no_peraturan') is-invalid @enderror" value="{{old('no_peraturan')}}" name="no_peraturan">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('no_peraturan')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="date" class="form-control @error('tgl_peraturan') is-invalid @enderror" value="{{old('tgl_peraturan')}}" name="tgl_peraturan">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('tgl_peraturan')
                                {{ $message }}
                                @enderror
