...
@section('content')
    ...
    <ul class="cbp_tmtimeline">
        <li>
            <time class="cbp_tmtime" datetime="2014-12-06T18:30"><span class="hidden">06/12/2014</span> <span
        ...
        <li>
            ...
            <div class="cbp_tmlabel">
                <h2><a href="#">Eroll Maxhuni</a> <span>uploaded</span> 12 <span>new photos to album</span> <a
                        href="#">Summer Trip</a></h2>
                    ...
                    <div class="col-xs-4">
                        ...
                        <a href="#">
                            <img src="assets/images/image-5.jpg"
                                class="img-responsive img-rounded full-width margin-bottom" />
                        </a>
