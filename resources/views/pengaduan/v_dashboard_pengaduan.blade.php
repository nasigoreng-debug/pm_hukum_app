...
<body>
    ...
    <div class="dashboard-header">
        ...
        <p>Monitoring dan Statistik Pengaduan Pengadilan Agama</p>
    </div>
    ...
    <div class="container-fluid">
        <div class="counter-card success">
            ...
            <div class="counter-value">
                <a href="/pgd_total">
                    <h1 class="num" data-target="{{ $pengaduan_total }}">0</h1>
                </a>
            </div>
        ...
        <div class="counter-card purple">
            ...
            <div class="counter-value">
                <a href="/pgd_berjalan">
                    <h1 class="num" data-target="{{ $pengaduan_berjalan }}">0</h1>
                </a>
            </div>
            <div class="additional-info">
                <p>Tahun berjalan</p>
    ...
    <div class="chart-container">
        <div class="chart-header">
            <h2>Statistik SPengaduan</h2>
            <p>Perbandingan Total dan Pengaduan {{ date('Y') }}</p>
        </div>
                ...
                <div class="progress-ring">
                    <svg width="120" height="120" viewBox="0 0 120 120">
                        ...
                        <circle class="progress-ring-progress success-progress" cx="60" cy="60" r="50" stroke-width="10" 
                            style="--dashoffset: {{ 314 * (1 - min($pengaduan_total/100, 1)) }};" />
                    </svg>
                    <div class="progress-text success-text">{{ $pengaduan_total }}</div>
                </div>
            </div>
            
            <div class="chart-item">
                <h3>Pengaduan {{ date('Y') }}</h3>
                <div class="progress-ring">
                    <svg width="120" height="120" viewBox="0 0 120 120">
                        <circle class="progress-ring-bg" cx="60" cy="60" r="50" stroke-width="10" />
                        <circle class="progress-ring-progress purple-progress" cx="60" cy="60" r="50" stroke-width="10" 
                            style="--dashoffset: {{ 314 * (1 - min($pengaduan_berjalan/100, 1)) }};" />
                    </svg>
                    <div class="progress-text purple-text">{{ $pengaduan_berjalan }}</div>
                </div>
            </div>
            ...
            <div class="chart-item">
                ...
                <div class="progress-ring">
                    <svg width="120" height="120" viewBox="0 0 120 120">
                        <circle class="progress-ring-bg" cx="60" cy="60" r="50" stroke-width="10" />
                        <circle class="progress-ring-progress success-progress" cx="60" cy="60" r="50" stroke-width="10" 
                            style="--dashoffset: {{ 314 * (1 - min($pengaduan_total/(max($pengaduan_total, $pengaduan_berjalan)+1), 1)) }};" />
                    </svg>
                    <div class="progress-text" style="color: #2c3e50;">
                        {{ $pengaduan_total > 0 ? round(($pengaduan_berjalan / $pengaduan_total) * 100, 1) : 0 }}%
                    </div>
                </div>
                <p style="margin-top: 10px;">
                    {{ $pengaduan_berjalan }} dari {{ $pengaduan_total }}<br> pengaduan tahun ini
                </p>
            </div>
        </div>
    </div>
