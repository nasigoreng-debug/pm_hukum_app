                ...
                <div class="col">
                    ...
                    <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="date" class="form-control @error('tgl_terima_pgd') is-invalid @enderror" value="{{old('tgl_terima_pgd')}}" name="tgl_terima_pgd" autofocus>
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="text" class="form-control @error('no_pgd') is-invalid @enderror" value="{{old('no_pgd')}}" name="no_pgd">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('no_pgd')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            <label>Pelapor</label>
                            <input type="text" class="form-control @error('pelapor') is-invalid @enderror" value="{{old('pelapor')}}" name="pelapor">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('pelapor')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="text" class="form-control @error('uraian_pgd') is-invalid @enderror" value="{{old('uraian_pgd')}}" name="uraian_pgd">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('uraian_pgd')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="date" class="form-control @error('dis_pm_hk') is-invalid @enderror" value="{{old('dis_pm_hk')}}" name="dis_pm_hk">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('dis_pm_hk')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="date" class="form-control @error('dis_kpta') is-invalid @enderror" value="{{old('dis_kpta')}}" name="dis_kpta">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('dis_kpta')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="date" class="form-control @error('dis_wkpta') is-invalid @enderror" value="{{old('dis_wkpta')}}" name="dis_wkpta">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('dis_wkpta')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="date" class="form-control @error('dis_hatiwasda') is-invalid @enderror" value="{{old('dis_hatiwasda')}}" name="dis_hatiwasda">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('dis_hatiwasda')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="date" class="form-control @error('tgl_tindak_lanjut') is-invalid @enderror" value="{{old('tgl_tindak_lanjut')}}" name="tgl_tindak_lanjut">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="date" class="form-control @error('tgl_selesai_pgd') is-invalid @enderror" value="{{old('tgl_selesai_pgd')}}" name="tgl_selesai_pgd">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="date" class="form-control @error('tgl_lhp') is-invalid @enderror" value="{{old('tgl_lhp')}}" name="tgl_lhp">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('tgl_lhp')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="file" class="form-control @error('surat_pgd') is-invalid @enderror" value="{{old('surat_pgd')}}" name="surat_pgd">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('surat_pgd')
                                {{ $message }}
                                @enderror
