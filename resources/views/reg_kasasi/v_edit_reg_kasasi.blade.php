...
@section('content')
    ...
    <div class="panel panel-default container">
        ...
        <div class="panel-body">
            ...
            <form action="/reg_kasasi/update/{{ $reg_kasasi->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <!-- left column -->
                    <div class="col">
                        ...
                        <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                            ...
                            <div class="form-group col-xs-4">
                                ...
                                <select name="pa_pengaju" class="form-control @error('pa_pengaju') is-invalid @enderror"
                                    autofocus>
                            ...
                            <div class="form-group col-xs-4">
                                ...
                                <input type="date" class="form-control @error('tgl_masuk') is-invalid @enderror"
                                    value="{{ $reg_kasasi->tgl_masuk }}" name="tgl_masuk">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_masuk')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-xs-4">
                                ...
                                <input type="date" class="form-control @error('tgl_register') is-invalid @enderror"
                                    value="{{ $reg_kasasi->tgl_register }}" name="tgl_register">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_register')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-xs-4">
                                ...
                                <input type="text" class="form-control @error('no_kasasi') is-invalid @enderror"
                                    value="{{ $reg_kasasi->no_kasasi }}" name="no_kasasi">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_kasasi')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-xs-4">
                                ...
                                <input type="text" class="form-control @error('no_banding') is-invalid @enderror"
                                    value="{{ $reg_kasasi->no_banding }}" name="no_banding">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_banding')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-xs-4">
                                ...
                                <input type="date" class="form-control @error('tgl_put_banding') is-invalid @enderror"
                                    value="{{ $reg_kasasi->tgl_put_banding }}" name="tgl_put_banding">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                            ...
                            <div class="form-group col-xs-4">
                                ...
                                <input type="text" class="form-control @error('no_pa') is-invalid @enderror"
                                    value="{{ $reg_kasasi->no_pa }}" name="no_pa">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_pa')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-xs-4">
                                ...
                                <input type="date" class="form-control @error('tgl_put_pa') is-invalid @enderror"
                                    value="{{ $reg_kasasi->tgl_put_pa }}" name="tgl_put_pa">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_put_pa')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-xs-4">
                                ...
                                <input type="text" class="form-control @error('pemohon_kasasi') is-invalid @enderror"
                                    value="{{ $reg_kasasi->pemohon_kasasi }}" name="pemohon_kasasi">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                            ...
                            <div class="form-group col-xs-4">
                                ...
                                <input type="text" class="form-control @error('termohon_kasasi') is-invalid @enderror"
                                    value="{{ $reg_kasasi->termohon_kasasi }}" name="termohon_kasasi">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                            ...
                            <div class="form-group col-xs-4">
                                <label>Tanggal Putus Kasasi</label> <label class="text-red">(Diisi jika sudah
                                    putus!!!)</label>
                                <input type="date" class="form-control @error('tgl_put_kasasi') is-invalid @enderror"
                                    value="{{ $reg_kasasi->tgl_put_kasasi }}" name="tgl_put_kasasi">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
