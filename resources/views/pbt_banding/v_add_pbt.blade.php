                ...
                <div class="col">
                    ...
                    <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="text" class="form-control @error('no_banding') is-invalid @enderror" value="{{old('no_banding')}}" name="no_banding" autofocus>
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('no_banding')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="date" class="form-control @error('tgl_pbt_p') is-invalid @enderror" value="{{old('tgl_pbt_p')}}" name="tgl_pbt_p">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('tgl_pbt_p')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="date" class="form-control @error('tgl_pbt_t') is-invalid @enderror" value="{{old('tgl_pbt_t')}}" name="tgl_pbt_t">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('tgl_pbt_t')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="file" class="form-control @error('pbt_put') is-invalid @enderror" value="{{old('pbt_put')}}" name="pbt_put">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('pbt_put')
                                {{ $message }}
                                @enderror
