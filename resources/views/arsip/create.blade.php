                    ...
                    <div class="col-md-6">
                        <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <select name="no_lemari" class="form-control @error('no_lemari') is-invalid @enderror"
                                    id="no_lemari">
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="text" class="form-control @error('no_laci') is-invalid @enderror"
                                    value="{{ old('no_laci') }}" name="no_laci">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_laci')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                <label>No. Box</label>
                                <input type="text" class="form-control @error('no_box') is-invalid @enderror"
                                    value="{{ old('no_box') }}" name="no_box">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_box')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="date" class="form-control @error('tgl_alih_media') is-invalid @enderror"
                                    value="{{ old('tgl_alih_media') }}" name="tgl_alih_media">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="file" class="form-control @error('bundel_b') is-invalid @enderror"
                                    value="{{ old('bundel_b') }}" name="bundel_b">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('bundel_b')
                                        {{ $message }}
                                    @enderror
