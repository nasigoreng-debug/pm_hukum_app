                    ...
                    <div class="col">
                        ...
                        <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="date" class="form-control @error('tgl_masuk_pan') is-invalid @enderror"
                                    value="{{ $suratmasuk->tgl_masuk_pan }}" name="tgl_masuk_pan" autofocus>
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="date" class="form-control @error('tgl_masuk_umum') is-invalid @enderror"
                                    value="{{ $suratmasuk->tgl_masuk_umum }}" name="tgl_masuk_umum" autofocus>
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="text" class="form-control @error('no_indeks') is-invalid @enderror"
                                    value="{{ $suratmasuk->no_indeks }}" name="no_indeks">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_indeks')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="text" class="form-control @error('no_surat') is-invalid @enderror"
                                    value="{{ $suratmasuk->no_surat }}" name="no_surat">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_surat')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="date" class="form-control @error('tgl_surat') is-invalid @enderror"
                                    value="{{ $suratmasuk->tgl_surat }}" name="tgl_surat">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_surat')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="text" class="form-control @error('perihal') is-invalid @enderror"
                                    value="{{ $suratmasuk->perihal }}" name="perihal">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('perihal')
                                        {{ $message }}
                                    @enderror
                                ...
                                <div class="">
                                    <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                        ...
                                        <input type="file"
                                            ...
                                            value="{{ $suratmasuk->lampiran }}" name="lampiran">
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="text" class="form-control @error('keterangan') is-invalid @enderror"
                                    value="{{ $suratmasuk->keterangan }}" name="keterangan">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('keterangan')
                                        {{ $message }}
                                    @enderror
