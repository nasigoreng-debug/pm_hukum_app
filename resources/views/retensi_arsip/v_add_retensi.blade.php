                ...
                <div class="col">
                    ...
                    <div class="row col-margin">
                        ...
                        <div class="col-xs-2">
                            ...
                            <input type="text" class="form-control @error('pa_pengaju') is-invalid @enderror" value="{{old('pa_pengaju')}}" name="pa_pengaju">
                        ...
                        <div class="col-xs-3">
                            ...
                            <input type="text" class="form-control @error('pembanding') is-invalid @enderror" value="{{old('pembanding')}}" name="pembanding">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('pembanding')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xs-3">
                            ...
                            <input type="text" class="form-control @error('terbanding') is-invalid @enderror" value="{{old('terbanding')}}" name="terbanding">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('terbanding')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xs-3">
                            <label>Buku</label>
                            <input type="text" class="form-control @error('buku') is-invalid @enderror" value="{{old('buku')}}" name="buku">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('buku')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xs-3">
                            <label>Tingkat</label>
                            <input type="text" class="form-control @error('tingkat') is-invalid @enderror" value="{{old('tingkat')}}" name="tingkat">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('tingkat')
                                {{ $message }}
                                @enderror
