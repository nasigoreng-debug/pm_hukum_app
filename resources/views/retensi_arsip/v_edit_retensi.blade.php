                        ...
                        <div class="row col-margin">
                            ...
                            <div class="col-xs-2">
                                ...
                                <input type="text" class="form-control @error('pa_pengaju') is-invalid @enderror"
                                    value="{{ $retensi->pa_pengaju }}" name="pa_pengaju">
                            ...
                            <div class="col-xs-3">
                                ...
                                <input type="text" class="form-control @error('no_banding') is-invalid @enderror"
                                    value="{{ $retensi->no_banding }}" name="no_banding">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_banding')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xs-3">
                                ...
                                <input type="text" class="form-control @error('no_pa') is-invalid @enderror"
                                    value="{{ $retensi->no_pa }}" name="no_pa">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_pa')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xs-2">
                                ...
                                <input type="text" class="form-control @error('no_kasasi') is-invalid @enderror"
                                    value="{{ $retensi->no_kasasi }}" name="no_kasasi">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_kasasi')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xs-2">
                                ...
                                <input type="text" class="form-control @error('no_pk') is-invalid @enderror"
                                    value="{{ $retensi->no_pk }}" name="no_pk">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_pk')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xs-3">
                                ...
                                <input type="text" class="form-control @error('pembanding') is-invalid @enderror"
                                    value="{{ $retensi->pembanding }}" name="pembanding">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('pembanding')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xs-3">
                                ...
                                <input type="text" class="form-control @error('terbanding') is-invalid @enderror"
                                    value="{{ $retensi->terbanding }}" name="terbanding">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('terbanding')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xs-3">
                                ...
                                <input type="date" class="form-control @error('tgl_put_banding') is-invalid @enderror"
                                    value="{{ $retensi->tgl_put_banding }}" name="tgl_put_banding">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                            ...
                            <div class="col-xs-3">
                                ...
                                <input type="date" class="form-control @error('tgl_put_pa') is-invalid @enderror"
                                    value="{{ $retensi->tgl_put_pa }}" name="tgl_put_pa">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_put_pa')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xs-3">
                                ...
                                <input type="date" class="form-control @error('tgl_put_kasasi') is-invalid @enderror"
                                    value="{{ $retensi->tgl_put_kasasi }}" name="tgl_put_kasasi">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                            ...
                            <div class="col-xs-3">
                                ...
                                <input type="date" class="form-control @error('tgl_put_pk') is-invalid @enderror"
                                    value="{{ $retensi->tgl_put_pk }}" name="tgl_put_pk">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_put_pk')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xs-3">
                                ...
                                <input type="text" class="form-control @error('tingkat') is-invalid @enderror"
                                    value="{{ $retensi->tingkat }}" name="tingkat">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tingkat')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xs-3">
                                ...
                                <input type="text" class="form-control @error('tahun') is-invalid @enderror"
                                    value="{{ $retensi->tahun }}" name="tahun">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tahun')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-xs-3">
                                ...
                                <input type="file" class="form-control @error('putusan') is-invalid @enderror"
                                    value="{{ $retensi->putusan }}" name="putusan">
