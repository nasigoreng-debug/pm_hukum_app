        ...
        <table class="table table-sm table-hover" id="example-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        @if(Auth::user()->level===1)
                        <button type="button" class="btn btn-purple btn-xs" data-toggle="modal" data-target="#detail{{ $data->id_retensi }}">
                            <i class="fa fa-eye"></i></a>
                        </button>
                        <a href="/retensi/edit/{{$data->id_retensi}}" class="btn btn-warning btn-xs">
                            <i class="fa fa-edit"></i>
                        </a>
                        <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete{{ $data->id_retensi }}">
...
<!-- Modal Detail -->
<div class="modal fade" id="detail{{ $data->id_retensi }}" tabindex="-1">
...
<!-- Modal Hapus -->
<div class="modal fade" id="delete{{ $data->id_retensi }}">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">{{ $data->no_banding }} Jo. {{ $data->no_pa }} Jo. {{ $data->no_kasasi }} Jo. {{ $data->no_pk }} </h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-footer justify-content-between">
                <a href="/retensi/delete/{{$data->id_retensi}}" type="button" class="btn btn-sm btn-danger">Ya</a>
