...
@section('content')
    ...
    <div class="panel panel-default container">
        ...
        <div class="panel-body">
            ...
            <form action="/pk/update/{{ $pk->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <!-- left column -->
                    <div class="col">
                        ...
                        <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                            <div class="form-group col-xs-6">
                                ...
                                <input type="date" class="form-control @error('tgl_masuk') is-invalid @enderror"
                                    value="{{ $pk->tgl_masuk }}" name="tgl_masuk">
                            ...
                            <div class="form-group col-xs-6">
                                ...
                                <input type="text" class="form-control @error('no_banding') is-invalid @enderror"
                                    value="{{ $pk->no_banding }}" name="no_banding">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_banding')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div>
                                <div>
                                    <div class="form-group col-xs-6">
                                        ...
                                        <input type="file"
                                            class="form-control col-xs-6 form-control-sm @error('salput_pk') is-invalid @enderror"
                                            value="{{ $pk->salput_pk }}" name="salput_pk">
