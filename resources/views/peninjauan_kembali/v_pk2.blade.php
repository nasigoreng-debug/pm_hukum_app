        ...
        <table id="example-1" class="table table-small-font table-sm table-striped table-bordered table-hover" cellspacing="0" width="100%">
            <thead class="bg-gray">
                <tr>
                    ...
                    <th style="width: 120px;">Termohon</th>
                    <th style="width: 70px;">Nomor PK</th>
                    <th style="width: 60px;">Putus PK</th>
                    <th style="width: 30px;">Status Putusan</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="/pk/edit/{{$data->id_pk}}" class="btn btn-warning">
                            <i class="fa fa-edit"></i>
                        </a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 colspan="2" class="text-white text-center bg-success">Detail Putusan pk</h4>
            </div>
