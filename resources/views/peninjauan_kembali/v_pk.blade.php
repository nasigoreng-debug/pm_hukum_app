                    ...
                    @foreach ($pk as $data)
                        ...
                        @endif
                            ...
                            <td class="text-center">
                                ...
                                @if ($data->salput_pk == '')
                                @else
                                    <a href="public/peninjauan_kembali/{{ $data->salput_pk }}" class="text-blue"><i
                            ...
                            <td class="text-center">
                                @if (Auth::user()->level === 1)
                                    ...
                                    <a href="/pk/edit/{{ $data->id }}" class="btn btn-warning btn-xs">
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        <a href="/pk/delete/{{ $data->id }}" type="button" class="btn btn-sm btn-danger">Ya</a>
