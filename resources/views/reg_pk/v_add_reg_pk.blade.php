    ...
    <div class="panel panel-default container">
        ...
        <div class="panel-heading">
            <div class="panel-title">
                Input Data Regsiter Peninjauan Kembali
            </div>
        </div>

        <div class="panel-body">

            <form action="/reg_pk/insert" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <!-- left column -->
                    <div class="col">
                        ...
                        <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                            ...
                            <div class="form-group col-xs-3">
                                ...
                                <input type="date" class="form-control @error('tgl_register') is-invalid @enderror"
                                    value="{{ old('tgl_register') }}" name="tgl_register">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_register')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-xs-3">
                                ...
                                <input type="text" class="form-control @error('pemohon_pk') is-invalid @enderror"
                                    value="{{ old('pemohon_pk') }}" name="pemohon_pk">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('pemohon_pk')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-xs-3">
                                ...
                                <input type="text" class="form-control @error('termohon_pk') is-invalid @enderror"
                                    value="{{ old('termohon_pk') }}" name="termohon_pk">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('termohon_pk')
                                        {{ $message }}
                                    @enderror
