                        ...
                        <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                            ...
                            <div class="form-group col-xs-3">
                                ...
                                <input type="date" class="form-control @error('tgl_masuk') is-invalid @enderror"
                                    value="{{ $reg_pk->tgl_masuk }}" name="tgl_masuk">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_masuk')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-xs-3">
                                ...
                                <input type="date" class="form-control @error('tgl_register') is-invalid @enderror"
                                    value="{{ $reg_pk->tgl_register }}" name="tgl_register">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_register')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-xs-3">
                                ...
                                <input type="text" class="form-control @error('no_banding') is-invalid @enderror"
                                    value="{{ $reg_pk->no_banding }}" name="no_banding">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_banding')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-xs-3">
                                ...
                                <input type="date" class="form-control @error('tgl_put_banding') is-invalid @enderror"
                                    value="{{ $reg_pk->tgl_put_banding }}" name="tgl_put_banding">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                            ...
                            <div class="form-group col-xs-3">
                                ...
                                <input type="date" class="form-control @error('tgl_put_pa') is-invalid @enderror"
                                    value="{{ $reg_pk->tgl_put_pa }}" name="tgl_put_pa">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_put_pa')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-xs-3">
                                ...
                                <input type="text" class="form-control @error('pemohon_pk') is-invalid @enderror"
                                    value="{{ $reg_pk->pemohon_pk }}" name="pemohon_pk">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('pemohon_pk')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-xs-3">
                                ...
                                <input type="text" class="form-control @error('termohon_pk') is-invalid @enderror"
                                    value="{{ $reg_pk->termohon_pk }}" name="termohon_pk">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('termohon_pk')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-xs-3">
                                <label>Tanggal Putus Peninjauan Kembali</label> <label class="text-red">(Diisi jika sudah
                                    putus!!!)</label>
                                <input type="date" class="form-control @error('tgl_put_pk') is-invalid @enderror"
                                    value="{{ $reg_pk->tgl_put_pk }}" name="tgl_put_pk">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_put_pk')
                                        {{ $message }}
                                    @enderror
