                            ...
                            <td class="text-center">
                                ...
                                @else
                                    <span class="badge badge-success">
                                        {{ Carbon\Carbon::parse($data->tgl_register)->diffIndays($data->tgl_put_pk) }}
                                        Hari</span>
                                @endif
                            </td>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 colspan="2" class="text-white text-center bg-success">Detail Register Peninjauan Kembali
                        </h4>
                    </div>
