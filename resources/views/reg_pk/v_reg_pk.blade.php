...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">Data Register Peninjauan Kembali</h3>
    ...
    <div class="panel-body">
        ...
        <td class="text-center" style="font-size: 5px;">
            ...
            <a href="/reg_pk/add" class="btn btn-sm btn-info mb-2">Tambah Data</a>
        ...
        <table class="table table-sm table-hover" id="example-4">
            <thead class="bg-gray">
                <tr>
                    ...
                    <th class="text-center" style="width: 80px;">Box</th>

                    <th class="text-center" style="width: 100px;">Putus PK</th>
            ...
            <tfoot class="bg-gray">
                <tr>
                    ...
                    <th class="text-center">Putus PK</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <span class="badge badge-danger">{{Carbon\Carbon::parse($data->tgl_register)->diffIndays($sekarang)}} Hari</span>
                        @else
                        <span class="badge badge-success"> {{Carbon\Carbon::parse($data->tgl_register)->diffIndays($data->tgl_put_pk)}} Hari</span>
                        @endif
                    </td>
                    <!-- <td>{{ $data->keterangan }}</td> -->
                    <td class="text-center">
                        @if(Auth::user()->level===1)
                        <button type="button" class="btn btn-purple btn-xs" data-toggle="modal" data-target="#detail{{ $data->id_reg_pk }}">
                            <i class="fa fa-eye"></i></a>
                        </button>
                        <a href="/reg_pk/edit/{{$data->id_reg_pk}}" class="btn btn-warning btn-xs">
                            <i class="fa fa-edit"></i>
                        </a>
                        <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete{{ $data->id_reg_pk }}">
                        ...
                        @elseif(Auth::user()->level===3)
                        <a href="/reg_pk/detail/{{$data->id_reg_pk}}" class="btn btn-purple btn-xs">
                            <i class="fa fa-eye"></i></a>
                        </a>
                        @endif
                    </td>
...
<!-- Modal Detail -->
<div class="modal fade" id="detail{{ $data->id_reg_pk }}" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 colspan="2" class="text-white text-center bg-success">Detail Register Peninjauan Kembali</h4>
            </div>
...
<!-- Modal Hapus -->
<div class="modal fade" id="delete{{ $data->id_reg_pk }}">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                <a href="/reg_pk/delete/{{$data->id_reg_pk}}" type="button" class="btn btn-sm btn-danger">Ya</a>
