...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-progress-counter xe-progress-counter-orange animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $arsip_masuk }}" data-duration="2">
        ...
        <!-- Bank Putusan -->
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-progress-counter xe-progress-counter-green animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $bankput_putus }}" data-duration="2">
                <div class="xe-background">
        ...
        <!-- Surat Masuk -->
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-progress-counter xe-progress-counter-red animated-widget" 
                 data-count=".num" data-from="0" data-to="{{$suratmasuk_number}}" data-duration="2">
                <div class="xe-background">
        ...
        <!-- Surat Keluar -->
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-progress-counter xe-progress-counter-turquoise animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $suratkeluar }}" data-duration="3">
                <div class="xe-background">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-progress-counter xe-progress-counter-green animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $pinjam }}" data-duration="5">
                <div class="xe-background">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-progress-counter xe-progress-counter-red animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $himper_total }}" data-duration="2">
                <div class="xe-background">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-progress-counter xe-progress-counter-turquoise animated-widget" 
                 data-count=".num" data-from="0" data-to="{{$kasasi}}" data-duration="2">
        ...
        <!-- PBT Putusan Banding -->
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-progress-counter xe-progress-counter-purple animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $pbt }}" data-duration="3">
                <div class="xe-background">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-progress-counter xe-progress-counter-red animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $pgd_blm_selesai }}" data-duration="3">
                <div class="xe-background">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-progress-counter xe-progress-counter-turquoise animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $pk }}" data-duration="3">
                <div class="xe-background">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-progress-counter xe-progress-counter-purple animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $retensi_total }}" data-duration="3">
                <div class="xe-background">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-progress-counter xe-progress-counter-orange animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $reg_kasasi_blm_selesai }}" data-duration="3">
                <div class="xe-background">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-progress-counter xe-progress-counter-turquoise animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $reg_pk_blm_selesai }}" data-duration="3">
                <div class="xe-background">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-progress-counter xe-progress-counter-purple animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $eksekusi_blm_selesai }}" data-duration="3">
                <div class="xe-background">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="xe-widget xe-progress-counter xe-progress-counter-orange animated-widget" 
                 data-count=".num" data-from="0" data-to="{{ $sk_blm_upload }}" data-duration="3">
                <div class="xe-background">
