                ...
                <div class="col">
                    ...
                    <div class="row col-margin">
                        ...
                        <div class="col-xs-6">
                            ...
                            <select name="status_putus" class="form-control @error('status_putus') is-invalid @enderror">
                        ...
                        <div class="col-xs-6">
                            <label>Putusan</label>
                            <input type="file" class="form-control @error('put_rtf') is-invalid @enderror" value="{{old('put_rtf')}}" name="put_rtf">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('put_rtf')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="col-xs-6">
                            ...
                            <input type="file" class="form-control @error('put_anonim') is-invalid @enderror" value="{{old('put_anonim')}}" name="put_anonim">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('put_anonim')
                                {{ $message }}
                                @enderror
