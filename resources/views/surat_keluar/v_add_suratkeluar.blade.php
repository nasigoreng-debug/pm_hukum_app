                        ...
                        <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="text" class="form-control @error('no_surat') is-invalid @enderror"
                                    value="{{ old('no_surat') }}" name="no_surat" autofocus>
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="date" class="form-control @error('tgl_surat') is-invalid @enderror"
                                    value="{{ old('tgl_surat') }}" name="tgl_surat" autofocus>
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_surat')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="file" class="form-control @error('surat_pta') is-invalid @enderror"
                                    value="{{ old('surat_pta') }}" name="surat_pta">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('surat_pta')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="file" class="form-control @error('konsep_surat') is-invalid @enderror"
                                    value="{{ old('konsep_surat') }}" name="konsep_surat">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('konsep_surat')
                                        {{ $message }}
                                    @enderror
