                    ...
                    <div class="col">
                        ...
                        <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="text" class="form-control @error('no_surat') is-invalid @enderror"
                                    value="{{ $suratkeluar->no_surat }}" name="no_surat" autofocus>
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="date" class="form-control @error('tgl_surat') is-invalid @enderror"
                                    value="{{ $suratkeluar->tgl_surat }}" name="tgl_surat" autofocus>
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('tgl_surat')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <input type="text" class="form-control @error('perihal') is-invalid @enderror"
                                    value="{{ $suratkeluar->perihal }}" name="perihal">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('perihal')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                ...
                                <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                    <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                        ...
                                        <input type="file"
                                            class="form-control form-control-sm @error('surat_pta') is-invalid @enderror"
                                            value="{{ $suratkeluar->surat_pta }}" name="surat_pta">
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <div class="">
                                <div class="form-group ml-3 mt-2 mb-2 mr-3">
                                    ...
                                    <input type="file"
                                        class="form-control form-control-sm @error('konsep_surat') is-invalid @enderror"
                                        value="{{ $suratkeluar->konsep_surat }}" name="konsep_surat">
                                    <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                        @error('konsep_surat')
                                            {{ $message }}
                                        @enderror
                        ...
                        <div class="form-group ml-3 mt-2 mb-2 mr-3">
                            ...
                            <input type="text" class="form-control @error('keterangan') is-invalid @enderror"
                                value="{{ $suratkeluar->keterangan }}" name="keterangan">
                            <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                @error('keterangan')
                                    {{ $message }}
                                @enderror
