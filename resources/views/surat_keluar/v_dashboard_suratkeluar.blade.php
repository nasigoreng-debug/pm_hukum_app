...
<head>
    ...
    <title>Dashboard Surat Keluar</title>
...
<body>
    ...
    <div class="top-navigation">
        ...
        <div class="main-menu">
            ...
            <a href="/suratmasuk" class="menu-button">
    ...
    <div class="dashboard-header">
        <h1>Dashboard Surat Keluar</h1>
        <p>Monitoring dan Statistik Surat Keluar Pengadilan Agama</p>
    </div>
    ...
    <div class="container-fluid">
        <div class="counter-card success">
            ...
            <div class="counter-value">
                <a href="/suratkeluar_total">
                    <h1 class="num" data-target="{{ $suratkeluar_total }}">0</h1>
                </a>
            </div>
        ...
        <div class="counter-card purple">
            ...
            <div class="counter-value">
                <a href="/suratkeluar_berjalan">
                    <h1 class="num" data-target="{{ $suratkeluar_berjalan }}">0</h1>
                </a>
            </div>
            <div class="additional-info">
                <p>Tahun berjalan</p>
    ...
    <div class="chart-container">
        <div class="chart-header">
            ...
            <p>Perbandingan Total dan Surat Keluar Tahun {{ date('Y') }}</p>
        </div>
                ...
                <div class="progress-ring">
                    <svg width="120" height="120" viewBox="0 0 120 120">
                        ...
                        <circle class="progress-ring-progress success-progress" cx="60" cy="60" r="50" stroke-width="10" 
                            style="--dashoffset: {{ 314 * (1 - min($suratkeluar_total/100, 1)) }};" />
                    </svg>
                    <div class="progress-text success-text">{{ $suratkeluar_total }}</div>
                </div>
            </div>
            
            <div class="chart-item">
                <h3>Surat Keluar {{ date('Y') }}</h3>
                <div class="progress-ring">
                    <svg width="120" height="120" viewBox="0 0 120 120">
                        <circle class="progress-ring-bg" cx="60" cy="60" r="50" stroke-width="10" />
                        <circle class="progress-ring-progress purple-progress" cx="60" cy="60" r="50" stroke-width="10" 
                            style="--dashoffset: {{ 314 * (1 - min($suratkeluar_berjalan/100, 1)) }};" />
                    </svg>
                    <div class="progress-text purple-text">{{ $suratkeluar_berjalan }}</div>
                </div>
            </div>
            ...
            <div class="chart-item">
                ...
                <div class="progress-ring">
                    <svg width="120" height="120" viewBox="0 0 120 120">
                        <circle class="progress-ring-bg" cx="60" cy="60" r="50" stroke-width="10" />
                        <circle class="progress-ring-progress success-progress" cx="60" cy="60" r="50" stroke-width="10" 
                            style="--dashoffset: {{ 314 * (1 - min($suratkeluar_total/(max($suratkeluar_total, $suratkeluar_berjalan)+1), 1)) }};" />
                    </svg>
                    <div class="progress-text" style="color: #2c3e50;">
                        {{ $suratkeluar_total > 0 ? round(($suratkeluar_berjalan / $suratkeluar_total) * 100, 1) : 0 }}%
                    </div>
                </div>
                <p style="margin-top: 10px;">
                    {{ $suratkeluar_berjalan }} dari {{ $suratkeluar_total }}<br>surat tahun ini
                </p>
            </div>
        </div>
    </div>
