...
@section('content')
    ...
    <div class="panel panel-default container">
        ...
        <div class="panel-body">
            ...
            <form action="/kasasi/update/{{ $kasasi->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <!-- left column -->
                    <div class="col">
                        ...
                        <div class="card card-primary mt-3 ml-3 mb-3 mr-3">
                            <div class="form-group col-xs-6">
                                ...
                                <input type="date" class="form-control @error('tgl_masuk') is-invalid @enderror"
                                    value="{{ $kasasi->tgl_masuk }}" name="tgl_masuk">
                            ...
                            <div class="form-group col-xs-6">
                                ...
                                <input type="text" class="form-control @error('no_banding') is-invalid @enderror"
                                    value="{{ $kasasi->no_banding }}" name="no_banding">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_banding')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-xs-6">
                                ...
                                <input type="text" class="form-control @error('no_kasasi') is-invalid @enderror"
                                    value="{{ $kasasi->no_kasasi }}" name="no_kasasi">
                                <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                    @error('no_kasasi')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div>
                                <div>
                                    <div class="form-group col-xs-6">
                                        ...
                                        <input type="file"
                                            class="form-control  col-xs-6  @error('salput_kasasi') is-invalid @enderror"
                                            value="{{ $kasasi->salput_kasasi }}" name="salput_kasasi">
                                        <div id="validationServerUsernameFeedback" class="invalid-feedback text-danger">
                                            @error('salput_kasasi')
                                                {{ $message }}
                                            @enderror
