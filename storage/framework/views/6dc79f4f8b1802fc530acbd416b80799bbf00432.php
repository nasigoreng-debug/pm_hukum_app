        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-success animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($pengaduan_total); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-purple animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($pengaduan_berjalan); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
                        <i class="fa fa-users bounce"></i>
                        <h4 class="widget-title">PENGADUAN <?php echo e(date('Y')); ?></h4>
                    </div>
                    <div class="xe-label">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-danger animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($pengaduan_blm_selesai); ?>" data-decimal="," data-suffix=""
                    data-duration="2.5">
                    <div class="xe-icon">
...
<?php echo $__env->make('layouts.v_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\pm_hukum_app\resources\views//pengaduan/v_dashboard_pengaduan.blade.php ENDPATH**/ ?>