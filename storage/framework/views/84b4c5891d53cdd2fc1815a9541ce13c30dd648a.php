        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-purple animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($eksekusi_total); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-purple animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($eksekusi_putusan); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-purple animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($eksekusi_ht); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-success animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($eksekusi_selesai); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-danger animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($eksekusi_blm_selesai); ?>" data-decimal="," data-suffix=""
                    data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($eksekusi_presentase); ?>" data-decimal="," data-suffix="%"
                    data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($eksekusi_riil); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($eksekusi_lelang); ?>" data-decimal="," data-suffix=""
                    data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($eksekusi_dicabut); ?>" data-decimal="," data-suffix=""
                    data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($eksekusi_dicoret); ?>" data-decimal="," data-suffix=""
                    data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($eksekusi_ne); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
...
<?php echo $__env->make('layouts.v_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\pm_hukum_app\resources\views//eksekusi/v_dashboard_eksekusi.blade.php ENDPATH**/ ?>