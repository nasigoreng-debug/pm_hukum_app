        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-info animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($arsip_perkara_total); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
                        <i class="fa fa-file-text-o pulse"></i>
                        <h4 class="widget-title">TOTAL ARSIP PERKARA</h4>
                    </div>
                    <div class="xe-label">
                        <a href="<?php echo e(route('arsip.filter', 'total')); ?>" class="text-white">
                            <h1 class="num">0</h1>
                        </a>
                    </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-success animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($arsip_perkara_upload); ?>" data-decimal="," data-suffix=""
                    data-duration="2.5">
                    <div class="xe-icon">
                    ...
                    <div class="xe-label">
                        <a href="<?php echo e(route('arsip.filter', 'sudah-upload')); ?>" class="text-white">
                            <h1 class="num">0</h1>
                        </a>
                    </div>
                    <div class="widget-wave"></div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-danger animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($arsip_perkara_blm_upload); ?>" data-decimal="," data-suffix=""
                    data-duration="2.5">
                    <div class="xe-icon">
                    ...
                    <div class="xe-label">
                        <a href="<?php echo e(route('arsip.filter', 'belum-upload')); ?>" class="text-white">
                            <h1 class="num">0</h1>
                        </a>
                    </div>
                    <div class="widget-wave"></div>
...
<?php echo $__env->make('layouts.v_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\pm_hukum_app\resources\views/arsip/v_dashboard_arsip_perkara.blade.php ENDPATH**/ ?>