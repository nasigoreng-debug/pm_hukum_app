        ...
        <div class="row">
                    ...
                    <div class="px-2 bg-light">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="<?php echo e(asset('public/template')); ?>/assets/image-gallery/1.jpg" class="img-fluid w-100"
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-progress-counter xe-progress-counter-orange animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($arsip_masuk); ?>" data-duration="2">
                    ...
                    <div class="xe-upper">
                        ...
                        <div class="xe-label">
                            <span>Arsip perkara <?php echo e(date('Y')); ?></span>
                            <strong class="num">0</strong>
                        </div>
                    </div>
                    <div class="xe-progress">
                        <span class="xe-progress-fill" data-fill-from="0" data-fill-to="<?php echo e($arsip_presentase); ?>"
                            data-fill-unit="%" data-fill-property="width" data-fill-duration="2"
                            data-fill-easing="true"></span>
                    </div>
                    <div class="xe-lower">
                        <span>Doc Arsip Perkara</span>
                        <strong><?php echo e($arsip_total); ?></strong>
                    </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-progress-counter xe-progress-counter-green animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($bankput_putus); ?>" data-duration="2">
                    <div class="xe-background">
                    ...
                    <div class="xe-upper">
                        ...
                        <div class="xe-label">
                            <span> Bank Putusan <?php echo e(date('Y')); ?></span>
                            <strong class="num">0</strong>
                        </div>
                    </div>
                    <div class="xe-progress">
                        <span class="xe-progress-fill" data-fill-from="0" data-fill-to="<?php echo e($bankput_presentase); ?>"
                            data-fill-unit="%" data-fill-property="width" data-fill-duration="2"
                            data-fill-easing="true"></span>
                    </div>
                    <div class="xe-lower">
                        <span>Jumlah putusan </span>
                        <strong><?php echo e($bankput_total); ?></strong>
                    </div>
                    <div class="widget-wave"></div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-progress-counter xe-progress-counter-red animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($suratmasuk_number); ?>" data-duration="2">
                    <div class="xe-background">
                    ...
                    <div class="xe-upper">
                        ...
                        <div class="xe-label">
                            <span>Surat Masuk Tahun <?php echo e(date('Y')); ?></span>
                            <strong class="num">0</strong>
                        </div>
                    </div>
                    <div class="xe-progress">
                        <span class="xe-progress-fill" data-fill-from="<?php echo e($suratmasuk_total); ?>"
                            data-fill-to="<?php echo e($suratmasuk_presentase); ?>" data-fill-unit="%" data-fill-property="width"
                            data-fill-duration="2" data-fill-easing="true"></span>
                    </div>
                    <div class="xe-lower">
                        <span>Jumlah Surat Masuk</span>
                        <strong><?php echo e($suratmasuk_total_number); ?></strong>
                    </div>
                    <div class="widget-wave"></div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-progress-counter xe-progress-counter-turquoise animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($suratkeluar); ?>" data-duration="3">
                    <div class="xe-background">
                    ...
                    <div class="xe-upper">
                        ...
                        <div class="xe-label">
                            <span>Surat Keluar Tahun <?php echo e(date('Y')); ?></span>
                            <strong class="num">0</strong>
                        </div>
                    </div>
                    <div class="xe-progress">
                        <span class="xe-progress-fill" data-fill-from="0" data-fill-to="<?php echo e($suratkeluar_presentase); ?>"
                            data-fill-unit="%" data-fill-property="width" data-fill-duration="3"
                            data-fill-easing="true"></span>
                    </div>
                    <div class="xe-lower">
                        <span>Jumlah Surat Keluar</span>
                        <strong><?php echo e($suratkeluar_total); ?></strong>
                    </div>
                    <div class="widget-wave"></div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-progress-counter xe-progress-counter-green animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($pinjam); ?>" data-duration="5">
                    <div class="xe-background">
                    ...
                    <div class="xe-upper">
                        ...
                        <div class="xe-label">
                            <span>Peminjam Berkas <?php echo e(date('Y')); ?></span>
                            <strong class="num">0</strong>
                        </div>
                    </div>
                    <div class="xe-progress">
                    ...
                    <div class="xe-lower">
                        <span>Belum Kembali <?php echo e(date('Y')); ?></span>
                        <strong><?php echo e($pinjam_bl_kembali); ?></strong>
                    </div>
                    <div class="widget-wave"></div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-progress-counter xe-progress-counter-red animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($himper_total); ?>" data-duration="2">
                    <div class="xe-background">
                    ...
                    <div class="xe-progress">
                        <span class="xe-progress-fill" data-fill-from="0" data-fill-to="<?php echo e($himper_presentase); ?>"
                            data-fill-unit="%" data-fill-property="width" data-fill-duration="2"
                            data-fill-easing="true"></span>
                    </div>
                    <div class="xe-lower">
                        <span>Jumlah Doc peraturan </span>
                        <strong><?php echo e($himper_upload); ?></strong>
                    </div>
                    <div class="widget-wave"></div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-progress-counter xe-progress-counter-turquoise animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($kasasi); ?>" data-duration="2">
                    ...
                    <div class="xe-upper">
                        ...
                        <div class="xe-label">
                            <span>Putusan Kasasi Yang Diterima <?php echo e(date('Y')); ?></span>
                            <strong class="num">0</strong>
                        </div>
                    </div>
                    <div class="xe-progress">
                        <span class="xe-progress-fill" data-fill-from="<?php echo e($suratmasuk_total); ?>"
                            data-fill-to="<?php echo e($kasasi_presentase); ?>" data-fill-unit="%" data-fill-property="width"
                            data-fill-duration="2" data-fill-easing="true"></span>
                    </div>
                    <div class="xe-lower">
                        <span>Jumlah Doc Putusan Kasasi</span>
                        <strong><?php echo e($kasasi_total); ?></strong>
                    </div>
                    <div class="widget-wave"></div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-progress-counter xe-progress-counter-purple animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($pbt); ?>" data-duration="3">
                    <div class="xe-background">
                    ...
                    <div class="xe-upper">
                        ...
                        <div class="xe-label">
                            <span>PBT Putusan Banding <?php echo e(date('Y')); ?></span>
                            <strong class="num">0</strong>
                        </div>
                    </div>
                    <div class="xe-progress">
                        <span class="xe-progress-fill" data-fill-from="0" data-fill-to="<?php echo e($pbt_presentase); ?>"
                            data-fill-unit="%" data-fill-property="width" data-fill-duration="3"
                            data-fill-easing="true"></span>
                    </div>
                    <div class="xe-lower">
                        <span>Jumlah PBT Putusan Banding</span>
                        <strong><?php echo e($pbt_total); ?></strong>
                    </div>
                    <div class="widget-wave"></div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-progress-counter xe-progress-counter-red animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($pgd_blm_selesai); ?>" data-duration="3">
                    <div class="xe-background">
                    ...
                    <div class="xe-progress">
                        <span class="xe-progress-fill" data-fill-from="0" data-fill-to="<?php echo e($pgd_presentase); ?>"
                            data-fill-unit="%" data-fill-property="width" data-fill-duration="3"
                            data-fill-easing="true"></span>
                    </div>
                    <div class="xe-lower">
                        <span>Jumlah Data Pengaduan</span>
                        <strong><?php echo e($pgd_total); ?></strong>
                    </div>
                    <div class="widget-wave"></div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-progress-counter xe-progress-counter-turquoise animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($pk); ?>" data-duration="3">
                    <div class="xe-background">
                    ...
                    <div class="xe-upper">
                        ...
                        <div class="xe-label">
                            <span>Putusan PK Yang DIterima <?php echo e(date('Y')); ?></span>
                            <strong class="num">0</strong>
                        </div>
                    </div>
                    <div class="xe-progress">
                        <span class="xe-progress-fill" data-fill-from="0" data-fill-to="<?php echo e($pk_presentase); ?>"
                            data-fill-unit="%" data-fill-property="width" data-fill-duration="3"
                            data-fill-easing="true"></span>
                    </div>
                    <div class="xe-lower">
                        <span>Jumlah Doc Putusan Peninjauan Kembali</span>
                        <strong><?php echo e($pk_total); ?></strong>
                    </div>
                    <div class="widget-wave"></div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-progress-counter xe-progress-counter-purple animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($retensi_total); ?>" data-duration="3">
                    <div class="xe-background">
                    ...
                    <div class="xe-progress">
                        <span class="xe-progress-fill" data-fill-from="0" data-fill-to="<?php echo e($retensi_presentase); ?>"
                            data-fill-unit="%" data-fill-property="width" data-fill-duration="3"
                            data-fill-easing="true"></span>
                    </div>
                    <div class="xe-lower">
                        <span>Jumlah Doc Retensi Arsip</span>
                        <strong><?php echo e($retensi_upload); ?></strong>
                    </div>
                    <div class="widget-wave"></div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-progress-counter xe-progress-counter-orange animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($reg_kasasi_blm_selesai); ?>" data-duration="3">
                    <div class="xe-background">
                    ...
                    <div class="xe-progress">
                        <span class="xe-progress-fill" data-fill-from="0" data-fill-to="<?php echo e($reg_kasasi_presentase); ?>"
                            data-fill-unit="%" data-fill-property="width" data-fill-duration="3"
                            data-fill-easing="true"></span>
                    </div>
                    <div class="xe-lower">
                        <span>Jumlah Kasasi Putus</span>
                        <strong><?php echo e($reg_kasasi_total); ?></strong>
                    </div>
                    <div class="widget-wave"></div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-progress-counter xe-progress-counter-turquoise animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($reg_pk_blm_selesai); ?>" data-duration="3">
                    <div class="xe-background">
                    ...
                    <div class="xe-progress">
                        <span class="xe-progress-fill" data-fill-from="0" data-fill-to="<?php echo e($reg_pk_presentase); ?>"
                            data-fill-unit="%" data-fill-property="width" data-fill-duration="3"
                            data-fill-easing="true"></span>
                    </div>
                    <div class="xe-lower">
                        <span>Jumlah PK Putus</span>
                        <strong><?php echo e($reg_pk_total); ?></strong>
                    </div>
                    <div class="widget-wave"></div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-progress-counter xe-progress-counter-purple animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($eksekusi_blm_selesai); ?>" data-duration="3">
                    <div class="xe-background">
                    ...
                    <div class="xe-progress">
                        <span class="xe-progress-fill" data-fill-from="0" data-fill-to="<?php echo e($eksekusi_presentase); ?>"
                            data-fill-unit="%" data-fill-property="width" data-fill-duration="3"
                            data-fill-easing="true"></span>
                    </div>
                    <div class="xe-lower">
                        <span>Total Perkara Eksekusi</span>
                        <strong><?php echo e($eksekusi_total); ?></strong>
                    </div>
                    <div class="widget-wave"></div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-progress-counter xe-progress-counter-orange animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($sk_blm_upload); ?>" data-duration="3">
                    <div class="xe-background">
                    ...
                    <div class="xe-upper">
                        ...
                        <div class="xe-label">
                            <span>Surat Keputusan <?php echo e(date('Y')); ?></span>
                            <strong class="num">0</strong>
                        </div>
                    </div>
                    <div class="xe-progress">
                        <span class="xe-progress-fill" data-fill-from="0" data-fill-to="<?php echo e($sk_presentase); ?>"
                            data-fill-unit="%" data-fill-property="width" data-fill-duration="3"
                            data-fill-easing="true"></span>
                    </div>
                    <div class="xe-lower">
                        <span>Jumlah Keputusan</span>
                        <strong><?php echo e($sk_total); ?></strong>
                    </div>
                    <div class="widget-wave"></div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="xe-widget xe-weather animated-widget">
                    <div class="xe-background xe-background-animated">
                        <img src="<?php echo e(asset('public/template')); ?>/assets/images/clouds.png" alt="Clouds Background" />
                    </div>
...
<?php echo $__env->make('layouts.v_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\pm_hukum_app\resources\views/dashboard.blade.php ENDPATH**/ ?>